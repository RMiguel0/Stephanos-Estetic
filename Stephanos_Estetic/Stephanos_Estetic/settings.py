...
SECRET_KEY = 'django-insecure-a*ei31nk+g*tw@=*i588z2%h(w)1@e*a%$0ebbrkn$#0l^q$t%'
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        "anon": "30/min",         # global anónimos
        "user": "120/min",
        "contact_form": "5/hour"  # scope usado en ContactRequestView
    },
}
